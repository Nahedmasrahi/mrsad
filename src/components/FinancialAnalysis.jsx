      ...
      <div className="grid md:grid-cols-2 gap-6 items-start">
        ...
        <div className="space-y-4">
          ...
          <div className="flex flex-col md:flex-row md:items-center md:gap-4 text-right">
            <label className="mb-1 md:mb-0 md:w-24">الدخل</label>
            <input
              type="number"
              value={income}
          ...
          {/* المصروفات */}
          <div className="flex flex-col md:flex-row md:items-center md:gap-4 text-right">
            <label className="mb-1 md:mb-0 md:w-24">المصروفات</label>
            <input
              type="number"
              value={expenses}
          ...
          {/* الالتزامات */}
          <div className="flex flex-col md:flex-row md:items-center md:gap-4 text-right">
            <label className="mb-1 md:mb-0 md:w-24">الالتزامات</label>
            <input
              type="number"
              value={commitments}
